...
public class Q1_Transactions{
    ...
    public static void main(String[]args) {
        try {
            String filename = "C:/Users/fzhan/Documents/GitHub/Big-Data-Management/Project 1/Project_1_FanglingZhang/Transactions.xls" ;
            ...
            for (int i=1;i<=100;i++){
				for (int j=1;j<=50000;j++){
					int k=50000*(i-1)+j;
			        XSSFRow row = sheet.createRow((int)k);
